...
var WebView = function (_Component) {
  ...
  function WebView() {
    ...
    }, _this.onWillNavigate = function (e) {
      _this.props.onNavigationStateChange({
        loading: true,
        url: e.url
      });
    }, _this.onDidNavigate = function (e) {
      _this.props.onNavigationStateChange({
        loading: false,
        url: e.url
      });
  ...
  _createClass(WebView, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          _onsc = _props.onNavigationStateChange,
          source = _props.source,
          props = _objectWithoutProperties(_props, ['injectedJavaScript', 'onError', 'onLoad', 'onLoadStart', 'onLoadEnd', 'onMessage', 'onNavigationStateChange', 'source']);
