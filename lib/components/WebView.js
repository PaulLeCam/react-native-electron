  ...
  _createClass(WebView, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          style = _props.style,
          props = _objectWithoutProperties(_props, ['injectedJavaScript', 'onMessage', 'source', 'style']);
      ...
      return _react2.default.createElement('webview', _extends({
        ...
        style: _reactNativeWeb.StyleSheet.flatten(style)
      }, extraProps, props));
    }
  }]);
...
WebView.propTypes = {
  injectedJavaScript: _react.PropTypes.string,
  ...
  style: _react.PropTypes.oneOfType([_react.PropTypes.array, _react.PropTypes.number, _react.PropTypes.object])
};
